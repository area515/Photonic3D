...
public class ImagePrintFileProcessor implements PrintFileProcessor<Object> {
	private Map<PrintJob, PrintImage> minerCubesByPrintJob = new HashMap<PrintJob, PrintImage>();
	...
	public BufferedImage getCurrentImage(PrintJob printJob) {
		PrintImage printCube = minerCubesByPrintJob.get(printJob);
	...
	public JobStatus processFile(PrintJob printJob) throws Exception {
		...
		PrintImage printCube = minerCubesByPrintJob.get(printJob);
		PrintImage cube = printCube.cube.get();
