...
public class DispManXDeviceOld implements GraphicsOutputInterface {
    ...
    public DispManXDeviceOld(String displayName, SCREEN screen) throws InappropriateDeviceException {
